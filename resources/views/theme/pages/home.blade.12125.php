                        ...
                        <div class="row">
                            <div class="col-md-6 half-one position-default">
                                <div class="floating-panel">
                                    <h2 class="h2 fw-semibold lh-base mb-4">'. $article->name .'</h2>
                                    <p class="text-muted">'. $article->teaser .'</p>
                ...
                <!-- <div class="oc-item">
                    <div class="ipost clearfix">
                        <div class="entry-image">
                            <a href="'. $article->get_url() .'" data-lightbox="image"><img class="image_fade" src="'. $imageUrl .'" alt="Standard Post with Image" style="border-radius: 14px;"></a>
                        </div>
                        <div class="entry-title" style="max-height: 70px;">
                        ...
                        <ul>
                            <li class="" style="list-style: none; display: flex; align-content: center; opacity: .6; padding-top: 10px;">
                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" class="mr-2" style="margin-top: 1.7px; margin-right: 4px;">
