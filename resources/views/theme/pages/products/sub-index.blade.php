				...
				<p class="pb-2" style="opacity: .8;">
					<small>
						<a href="{{ route('products') }}">Hydac Filtration Systems</a>
						 > 
						 <span style="text-decoration: underline;">Hydac Dewatering and Other Fluid Conditioning</span></small>
					<br />
					<br />
					<small>
				...
				<div class="row col-12">
					...
					<div class="col-md-3">
						<div class="card">
							<div class="card-header p-3 shadow bg-white">
								<img src="images/products/prd1.jpg" alt="Image 1">
							</div>
							<div class="card-body">
								<div class="grid-info text-center">
									<h5 class="text-center">Hydac Fluid Conditioning Systems</h5>
									<a href="{{ route('view-products') }}" class="btn btn-warning btn-sm">View Details</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="card">
							...
							<div class="card-body">
								<div class="grid-info text-center">
									<h5 class="text-center">Flushing Units</h5>
									<a href="{{ route('view-products') }}" class="btn btn-warning btn-sm">View Details</a>
								</div>
							</div>
						</div>
					...
					<div class="col-md-3">
						<div class="card">
							...
							<div class="card-body">
								<div class="grid-info text-center">
									<h5 class="text-center">Static Filtration Systems</h5>
									<a href="{{ route('view-products') }}" class="btn btn-warning btn-sm">View Details</a>
								</div>
							</div>
						</div>
					...
					<div class="col-md-3">
						<div class="card">
							...
							<div class="card-body">
								<div class="grid-info text-center">
									<h5 class="text-center">Mobile Filtration Systems</h5>
									<a href="{{ route('view-products') }}" class="btn btn-warning btn-sm">View Details</a>
								</div>
							</div>
						</div>
