            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-5">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Cases Status</li>
                    </ol>
                </nav>
                <h4 class="mg-b-0 tx-spacing--1">Manage Cases Status</h4>
            </div>
        </div>
                    ...
                    <div class="d-md-flex bd-highlight">
                        ...
                        <div class="mg-t-10">
                            @if (auth()->user()->has_access_to_route('resource-categories.create'))
                                <a class="btn btn-primary btn-sm mg-b-10" href="{{ route('resource-categories.create') }}">Create a Status</a>
                            @endif
                        </div>
                    </div>
                </div>
                                        ...
                                        @else
                                            <nav class="nav table-options">
                                                @if (auth()->user()->has_access_to_route('file-categories.edit'))
                                                    <a class="nav-link" href="{{ route('resource-categories.edit',$category->id) }}" title="Edit Status"><i data-feather="edit"></i></a>
                                                @endif

                                                @if (auth()->user()->has_access_to_route('file-category.single.delete'))
                                                    <a class="nav-link" href="javascript:void(0)" onclick="delete_one_category({{$category->id}},'{{$category->name}}')" title="Delete Status"><i data-feather="trash"></i></a>
                                                @endif
