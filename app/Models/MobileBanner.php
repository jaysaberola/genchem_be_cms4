...
class MobileBanner extends Model
{
    ...
    public static function validator()
    {
        return Validator::make(request()->all(), [
            ...
            'banners.*.image' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:20480',
        ], [
            ...
            'banners.*.image.max' => 'Each banner image must not be greater than 20MB.',
            'banners.*.image.image' => 'Each banner must be a valid image file.',
        ]);
    }
